...
export function RequireAffiliationFinance({
  telemetry,
  children,
}: {
  readonly telemetry: ButtonTelemetry;
  ...
  if (!view.capabilities.includes(ButtonCapability.ReviewAffiliationFinance)) {
    return (
      <RedirectWithTelemetry
        to="/button/access-denied"
        event="route.denied"
...
export function RequireAffiliationStanding({
  telemetry,
  children,
}: {
  readonly telemetry: ButtonTelemetry;
  ...
  if (!view.capabilities.includes(ButtonCapability.ViewAffiliationStanding)) {
    return (
      <RedirectWithTelemetry
        to="/button/access-denied"
        event="route.denied"
