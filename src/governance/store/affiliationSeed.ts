...
const SPECS: TransitionSpec[] = [
  ...
  { trigger: 'activate', fromState: 'approved', toState: 'active', risk: 'low', evidence: false, approval: false, guards: ['SEASON_IS_CURRENT'] },
  { trigger: 'suspend', fromState: 'active', toState: 'suspended', risk: 'high', evidence: true, approval: true, guards: ['ACTOR_HAS_REVIEWER_SCOPE'] },
  { trigger: 'reinstate', fromState: 'suspended', toState: 'active', risk: 'high', evidence: true, approval: true, guards: ['AFFILIATION_NO_OPEN_COMPLIANCE_FLAGS', 'ACTOR_HAS_REVIEWER_SCOPE'] },
