// Orchestrator for `npm run governance:check:v12`.
//
// Runs every Volume 12 governance control against a single loaded context,
// regenerates the non-authoritative control report, foundation projections,
// provenance-integrity projections, and Gate V12-G1 readiness projection, prints an
...
import { generate as generateFoundation } from './foundation-volume-12.mjs';
import { generate as generateProvenance } from './provenance-integrity-volume-12.mjs';
import { generate as generateGate } from './gate-g1-volume-12.mjs';
import { generate as generateFoundationAffiliation } from './foundation-affiliation-volume-12.mjs';
import { generate as generateGate2 } from './gate-g2-volume-12.mjs';
import { generate as generateFinalClosure } from './final-closure-volume-12.mjs';
import { generate as generateGate3 } from './gate-g3-volume-12.mjs';
...
generateGate(ctx);
generateFoundationAffiliation(ctx);
generateGate2(ctx);
generateFinalClosure(ctx);
generateGate3(ctx);

console.log('\n=== Volume 12 governance check summary ===');
