// Orchestrator for `npm run governance:check:v8`.
//
// Runs every Volume 8 governance control against a single loaded context,
// regenerates the non-authoritative control report, foundation projections, and
// Gate V8-G1 readiness projection, prints an aggregated summary, and exits
