# Volume 9 — Package 2 Provenance Amendment (V9-D)
...
This is an additive, post-merge provenance amendment for Volume 9 Package 2. It
...
- closure, gate, and freeze: the separate closure and freeze commit that recorded
  the Package 2 Closure Record, the Gate V9-G2 disposition, and the PACKAGE-9-2
  freeze;
- pre-merge provenance binding: the commit that bound the closure, gate, and
  freeze commit-hash fields to concrete identifiers;
- original Package 2 merge: the mainline merge commit that integrated Package 2.
...
Package 2 corpus, and it preserves the Gate V9-G2 disposition and the PACKAGE-9-2
freeze. It also preserves the Package 1 foundation, its Gate V9-G1 disposition, and
its PACKAGE-9-1 freeze. It confers no implementation, executable-test, environment,
...
Volume 9 is not tagged after Package 2.

The complete provenance-role classification, including this amendment's own
authoring and merge commits, is recorded in a subsequent amendment (V9-D-1) once
