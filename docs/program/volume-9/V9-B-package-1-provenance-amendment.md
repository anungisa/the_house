# Volume 9 — Package 1 Provenance Amendment (V9-B)
...
This is an additive, post-merge provenance amendment for Volume 9 Package 1. It
...
- closure, gate, and freeze: the separate closure and freeze commit that recorded
  the Package 1 Closure Record, the Gate V9-G1 disposition, and the PACKAGE-9-1
  freeze;
...
Package 1 corpus, and it preserves the Gate V9-G1 disposition and the PACKAGE-9-1
...
not tagged after Package 1.

The complete provenance-role classification, including this amendment's own
authoring and merge commits, is recorded in a subsequent amendment (V9-B-1) once
