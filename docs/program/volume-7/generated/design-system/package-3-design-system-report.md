...
| visual_systems | 2 |
| components | 21 |
| component_families | 16 |
| workbench_designs | 5 |
| reference_prototypes | 2 |
| design_specs | 4 |
| component_state_specs | 2 |
| content_terms | 4 |
...
| --- | --- | --- |
| missing_component_families | 0 | (none) |
| underspecified_components | 0 | (none) |
| components_without_semantic_source | 0 | (none) |
| missing_workbench_postures | 0 | (none) |
| missing_complete_states | 0 | (none) |
| content_terms_without_bilingual_concept | 0 | (none) |
| stages_without_reference_prototype | 0 | (none) |
| prototypes_not_labelled_candidate | 0 | (none) |
