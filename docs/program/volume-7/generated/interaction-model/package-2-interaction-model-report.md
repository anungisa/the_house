...
| command_intents | 17 |
| query_intents | 8 |
| validation_behaviours | 6 |
| content_requirements | 3 |
| status_messages | 4 |
| error_messages | 3 |
| recovery_paths | 3 |
| accessibility_behaviours | 4 |
| bilingual_semantics | 2 |

## Coverage backlog signals (non-blocking)

| Signal | Count | Identifiers |
| --- | --- | --- |
| actions_without_intent | 0 | (none) |
| commands_without_house_authority | 0 | (none) |
| surfaces_without_authority_domain | 0 | (none) |
| stages_without_surface_or_view | 0 | (none) |
| workbenches_without_constraints | 0 | (none) |
| missing_required_screen_states | 0 | (none) |
