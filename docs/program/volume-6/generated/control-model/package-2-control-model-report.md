...
Generated: 2026-07-26T21:50:54.108Z
...
- Identity, authentication, and session controls: 5

## Resource-aware authorization coverage

- Authorization control objectives: 3
- Isolation and service-trust controls: 3
...
- Restricted-evidence and disclosure controls: 2

## Privacy processing and rights mapping

- Privacy purpose, minimization, and rights controls: 3
- Rights mapped to a control objective: 1
...
- Blocking control-model gaps: 0 (must be 0)
