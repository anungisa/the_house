# Volume 6 Package 4 Incident, Resilience, Recovery, and Assurance Report (NON-AUTHORITATIVE)

Generated: 2026-07-27T00:02:15.819Z
...
- Operational control objectives: 16
- Control families in use: 10
- Controls without an owner: 0

## Event detection, triage, and investigation

- Detection and investigation control objectives: 2

## Incident classification, command, and closure

- Incident control objectives: 4
- Incident families: 4
- Families without evidence preservation: 0

## Breach-notification and communications dependencies

- Notification and communications controls: 2

## Vulnerability, configuration, and exception coverage

- Vulnerability, configuration, and exception controls: 3
- Exception controls without an expiry: 0

## Resilience, dependency-failure, and degraded-mode analysis

- Resilience controls: 1
- Resilience controls not failing closed: 0

## Backup, restore, recovery, and business-acceptance evidence

- Recovery control objectives: 2

## Provider continuity, exit, return, and deletion

- Provider-assurance control objectives: 1

## Control metrics, exercises, and assurance evidence

- Control-assurance control objectives: 2
- Assurance requirements: 5

## Cross-cutting integrity

- Package 4 obligations: 3
- Package 4 threats and abuse cases: 13
- Package 4 context assets: 10

## Incident-resilience-assurance model integrity

- Blocking incident-resilience-assurance gaps: 0 (must be 0)
