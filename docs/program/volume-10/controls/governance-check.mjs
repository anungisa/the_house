// Orchestrator for `npm run governance:check:v10`.
//
// Runs every Volume 10 governance control against a single loaded context,
// regenerates the non-authoritative control report, foundation projections,
// provenance-integrity projections, and Gate V10-G1 readiness projection, prints an
...
import { generate as generateGate3 } from './gate-g3-volume-10.mjs';
import { generate as generateFinalClosure } from './final-closure-volume-10.mjs';
