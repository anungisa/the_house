// Orchestrator for `npm run governance:check`.
//
// Runs every Volume 0 governance control against a single loaded context,
// regenerates the non-authoritative control report, prints an aggregated summary,
// and exits non-zero when any ERROR-severity finding is present.
...
// Regenerate the non-authoritative control report.
