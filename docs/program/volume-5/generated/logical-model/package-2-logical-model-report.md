...
Generated: 2026-07-26T18:11:11.936Z
...
| Category | Count |
| --- | --- |
| Logical entities and records | 33 |
| Logical relationships | 17 |
| Derived data products | 5 |
| Integrity rules | 14 |
| Validation/assumption/risk/exception backlog | 26 |

## Identity and authority separation

- Logical entities without an identity concept (must be 0): 0
- Logical entities without an owning domain (must be 0): 0

## Integrity-rule coverage

- Integrity rules without affected entities (must be 0): 0
- Integrity rules without a logical condition (must be 0): 0
