...
Generated: 2026-07-26T20:11:45.201Z
...
| Category | Count |
| --- | --- |
| Master and reference/vocabulary records | 18 |
| Data-quality rules | 14 |
| Data lifecycle records | 5 |
| Data issue records | 3 |
| Reconciliation contexts | 3 |
| Exchange records | 5 |
| Data use records | 5 |
...
- Master data sets without an authority owner (must be 0): 0
- Reference/vocabulary records without a version posture (must be 0): 3
- Data lifecycle records without a records authority (must be 0): 0
- Data issue records without a resolution authority (must be 0): 0
- Reconciliation contexts without a conflict authority (must be 0): 0
- Exchange records without a source authority (must be 0): 0
- Data use records without a permitted purpose (must be 0): 0
- Stewardship measures without an accountable owner (must be 0): 0
...
- Completed (passed) gates: V5-G1, V5-G2, V5-G3, V5-G4, V5-G5
